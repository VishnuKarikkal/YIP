...
function gameCheck() {
  ...
  let i = 0;
  while (i < 12) {
    monthChecks[i].disabled = false;
    i++;
  } //making all month checks active (first 12 aims -> the 1st table)
  if (checked > 0) {
          ...
          switch (res["games"][i].month) {
            case "JAN":
              if (res["games"][i].teamName == "NORTH") {
                document.getElementById("nJan").innerText =
                  res["games"][i].vote;
            ...
            case "FEB":
              if (res["games"][i].teamName == "NORTH") {
                document.getElementById("nFeb").innerText =
                  res["games"][i].vote;
              } else if (res["games"][i].teamName == "SOUTH") {
            ...
            case "MAR":
              if (res["games"][i].teamName == "NORTH") {
                document.getElementById("nMar").innerText =
                  res["games"][i].vote;
              } else if (res["games"][i].teamName == "SOUTH") {
            ...
            case "APR":
              if (res["games"][i].teamName == "NORTH") {
                document.getElementById("nApr").innerText =
                  res["games"][i].vote;
              } else if (res["games"][i].teamName == "SOUTH") {
            ...
            case "MAY":
              if (res["games"][i].teamName == "NORTH") {
                document.getElementById("nMay").innerText =
                  res["games"][i].vote;
              } else if (res["games"][i].teamName == "SOUTH") {
            ...
            case "JUN":
              if (res["games"][i].teamName == "NORTH") {
                document.getElementById("nJun").innerText =
                  res["games"][i].vote;
              } else if (res["games"][i].teamName == "SOUTH") {
            ...
            case "JUL":
              if (res["games"][i].teamName == "NORTH") {
                document.getElementById("nJul").innerText =
                  res["games"][i].vote;
              } else if (res["games"][i].teamName == "SOUTH") {
            ...
            case "AUG":
              if (res["games"][i].teamName == "NORTH") {
                document.getElementById("nAug").innerText =
                  res["games"][i].vote;
              } else if (res["games"][i].teamName == "SOUTH") {
            ...
            case "SEP":
              if (res["games"][i].teamName == "NORTH") {
                document.getElementById("nSep").innerText =
                  res["games"][i].vote;
              } else if (res["games"][i].teamName == "SOUTH") {
            ...
            case "OCT":
              if (res["games"][i].teamName == "NORTH") {
                document.getElementById("nOct").innerText =
                  res["games"][i].vote;
              } else if (res["games"][i].teamName == "SOUTH") {
            ...
            case "NOV":
              if (res["games"][i].teamName == "NORTH") {
                document.getElementById("nNov").innerText =
                  res["games"][i].vote;
              } else if (res["games"][i].teamName == "SOUTH") {
            ...
            default:
              if (res["games"][i].teamName == "NORTH") {
                document.getElementById("nDec").innerText =
                  res["games"][i].vote;
              } else if (res["games"][i].teamName == "SOUTH") {
...
function activateMonths() {
  ...
  if (months.length > 0) {
    $.post("/game/activate", { activateMonths: months }).done(function (data) {
        ...
        while (i < res["games"].length) {
          switch (res["games"][i].month) {
            case "JAN":
              ...
              if (res["games"][i].teamName == "NORTH") {
                document.getElementById("northVoteJan").innerText =
                  res["games"][i].vote;
              } else if (res["games"][i].teamName == "SOUTH") {
                document.getElementById("southVoteJan").innerText =
                  res["games"][i].vote;
              } else if (res["games"][i].teamName == "EAST") {
                document.getElementById("eastVoteJan").innerText =
                  res["games"][i].vote;
              } else {
                document.getElementById("westVoteJan").innerText =
                  res["games"][i].vote;
              }
              break;
            case "FEB":
              ...
              if (res["games"][i].teamName == "NORTH") {
                document.getElementById("northVoteFeb").innerText =
                  res["games"][i].vote;
              } else if (res["games"][i].teamName == "SOUTH") {
                document.getElementById("southVoteFeb").innerText =
                  res["games"][i].vote;
              } else if (res["games"][i].teamName == "EAST") {
                document.getElementById("eastVoteFeb").innerText =
                  res["games"][i].vote;
              } else {
                document.getElementById("westVoteFeb").innerText =
                  res["games"][i].vote;
              }
              break;
            case "MAR":
              ...
              if (res["games"][i].teamName == "NORTH") {
                document.getElementById("northVoteMar").innerText =
                  res["games"][i].vote;
              } else if (res["games"][i].teamName == "SOUTH") {
                document.getElementById("southVoteMar").innerText =
                  res["games"][i].vote;
              } else if (res["games"][i].teamName == "EAST") {
                document.getElementById("eastVoteMar").innerText =
                  res["games"][i].vote;
              } else {
                document.getElementById("westVoteMar").innerText =
                  res["games"][i].vote;
              }
              break;
            case "APR":
              ...
              if (res["games"][i].teamName == "NORTH") {
                document.getElementById("northVoteApr").innerText =
                  res["games"][i].vote;
              } else if (res["games"][i].teamName == "SOUTH") {
                document.getElementById("southVoteApr").innerText =
                  res["games"][i].vote;
              } else if (res["games"][i].teamName == "EAST") {
                document.getElementById("eastVoteApr").innerText =
                  res["games"][i].vote;
              } else {
                document.getElementById("westVoteApr").innerText =
                  res["games"][i].vote;
              }
              break;
            case "MAY":
              ...
              if (res["games"][i].teamName == "NORTH") {
                document.getElementById("northVoteMay").innerText =
                  res["games"][i].vote;
              } else if (res["games"][i].teamName == "SOUTH") {
                document.getElementById("southVoteMay").innerText =
                  res["games"][i].vote;
              } else if (res["games"][i].teamName == "EAST") {
                document.getElementById("eastVoteMay").innerText =
                  res["games"][i].vote;
              } else {
                document.getElementById("westVoteMay").innerText =
                  res["games"][i].vote;
              }
              break;
            case "JUN":
              ...
              if (res["games"][i].teamName == "NORTH") {
                document.getElementById("northVoteJun").innerText =
                  res["games"][i].vote;
              } else if (res["games"][i].teamName == "SOUTH") {
                document.getElementById("southVoteJun").innerText =
                  res["games"][i].vote;
              } else if (res["games"][i].teamName == "EAST") {
                document.getElementById("eastVoteJun").innerText =
                  res["games"][i].vote;
              } else {
                document.getElementById("westVoteJun").innerText =
                  res["games"][i].vote;
              }
              break;
            case "JUL":
              ...
              if (res["games"][i].teamName == "NORTH") {
                document.getElementById("northVoteJul").innerText =
                  res["games"][i].vote;
              } else if (res["games"][i].teamName == "SOUTH") {
                document.getElementById("southVoteJul").innerText =
                  res["games"][i].vote;
              } else if (res["games"][i].teamName == "EAST") {
                document.getElementById("eastVoteJul").innerText =
                  res["games"][i].vote;
              } else {
                document.getElementById("westVoteJul").innerText =
                  res["games"][i].vote;
              }
              break;
            case "AUG":
              ...
              if (res["games"][i].teamName == "NORTH") {
                document.getElementById("northVoteAug").innerText =
                  res["games"][i].vote;
              } else if (res["games"][i].teamName == "SOUTH") {
                document.getElementById("southVoteAug").innerText =
                  res["games"][i].vote;
              } else if (res["games"][i].teamName == "EAST") {
                document.getElementById("eastVoteAug").innerText =
                  res["games"][i].vote;
              } else {
                document.getElementById("westVoteAug").innerText =
                  res["games"][i].vote;
              }
              break;
            case "SEP":
              ...
              if (res["games"][i].teamName == "NORTH") {
                document.getElementById("northVoteSep").innerText =
                  res["games"][i].vote;
              } else if (res["games"][i].teamName == "SOUTH") {
                document.getElementById("southVoteSep").innerText =
                  res["games"][i].vote;
              } else if (res["games"][i].teamName == "EAST") {
                document.getElementById("eastVoteSep").innerText =
                  res["games"][i].vote;
              } else {
                document.getElementById("westVoteSep").innerText =
                  res["games"][i].vote;
              }
              break;
            case "OCT":
              ...
              if (res["games"][i].teamName == "NORTH") {
                document.getElementById("northVoteOct").innerText =
                  res["games"][i].vote;
              } else if (res["games"][i].teamName == "SOUTH") {
                document.getElementById("southVoteOct").innerText =
                  res["games"][i].vote;
              } else if (res["games"][i].teamName == "EAST") {
                document.getElementById("eastVoteOct").innerText =
                  res["games"][i].vote;
              } else {
                document.getElementById("westVoteOct").innerText =
                  res["games"][i].vote;
              }
              break;
            case "NOV":
              ...
              if (res["games"][i].teamName == "NORTH") {
                document.getElementById("northVoteNov").innerText =
                  res["games"][i].vote;
              } else if (res["games"][i].teamName == "SOUTH") {
                document.getElementById("southVoteNov").innerText =
                  res["games"][i].vote;
              } else if (res["games"][i].teamName == "EAST") {
                document.getElementById("eastVoteNov").innerText =
                  res["games"][i].vote;
              } else {
                document.getElementById("westVoteNov").innerText =
                  res["games"][i].vote;
              }
              break;
            default:
              ...
              if (res["games"][i].teamName == "NORTH") {
                document.getElementById("northVoteDec").innerText =
                  res["games"][i].vote;
              } else if (res["games"][i].teamName == "SOUTH") {
                document.getElementById("southVoteDec").innerText =
                  res["games"][i].vote;
              } else if (res["games"][i].teamName == "EAST") {
                document.getElementById("eastVoteDec").innerText =
                  res["games"][i].vote;
              } else {
                document.getElementById("westVoteDec").innerText =
                  res["games"][i].vote;
              }
          }
          i++;
...
function endGame() {
  ...
  let response = confirm("ARE YOU SURE? All datas will be erased!!"); //getting admin response
  if (response == true) {
    //if clicked OK
    month = "";
